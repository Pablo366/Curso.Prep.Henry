...
const nuevaString = "null también puede ser un string!";

// Crea una variable numérica, puede ser cualquier número:
const nuevoNum = 3.1415;
...
function areaDelTriangulo(base, altura){
  ...
  //Escribe tu código aquí
  var areaC = multiplica(base, altura);
  var areaT = divide(areaC, 2)
  return areaT;
}
